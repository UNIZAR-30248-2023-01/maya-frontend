      ...
      <SheetContent>
        <form onSubmit={e => handleSubmit(e)}>
          ...
          <div className="grid gap-4 py-4">
            <Field.Text
              id="name"
              label={dictionary.inandouts['day-column']}
              placeholder={dictionary.inandouts['new-table-name-placeholder']}
              onChange={(e) => setter({ key: 'name', value: e.target.value })}
            />
            <Field.TextArea
              id="description"
              label={dictionary.inandouts['description-column']}
              placeholder={dictionary.inandouts['new-table-desc-placeholder']}
              onChange={(e) => setter({ key: 'description', value: e.target.value })}
            />
            <Field.Bool
              id="visibility"
              label={dictionary.inandouts.public}
