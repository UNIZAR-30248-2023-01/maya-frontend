...
import { DataTableColumnHeader } from '@/components/project-people/data-table-column-header'
import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar'
import { Label } from '@/components/ui/label'
import { DataTableRowActions } from '@/components/project-people/data-table-row-actions'
