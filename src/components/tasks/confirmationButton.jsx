        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction className={isEdit ? 'bg-green-500 hover:bg-green-700' : 'bg-red-500 hover:bg-red-700'}>{isEdit ? dictionary.confirmation['confirmation-edit'] : dictionary.confirmation['confirmation-delete']}</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    )
