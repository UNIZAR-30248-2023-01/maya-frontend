...
export default function TaskPage ({ params }) {
  ...
  const { data: project, isLoading } = useSWR(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/rest/v1/projects?name=eq.${params.projectName}&select=*,people:people-project(*)`)
