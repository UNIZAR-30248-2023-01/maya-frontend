...
export default function PeoplePage ({ projectName, organization }) {
  ...
  return <DataTable data={people || loadingPeople} columns={columns} projectName={projectName} organization={organization}/>
}
